...
namespace BackendFirmaKolejowa.db.repository
{
    public class CompanyDatabase
    {
        ...
        public CompanyDatabase(TrainContext trainContext)
        {
        ...
        {
            var addedTrain = trainContext.Add(train);
            trainContext.SaveChanges();
            return addedTrain.Entity.id;
     ...
     //   }
     //
        public DbSet<Train> getTrains()
        {
            return trainContext.trains;
        }
     //
